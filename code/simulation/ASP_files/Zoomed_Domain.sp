...
holds(loc(rob1,c8), 0).
holds(coarse_loc(book2,kitchen), 0).
hpd(test(rob1,loc(ref1_book2,c7),true),3).obs(loc(rob1,c6),true,6).
hpd(test(rob1,loc(rob1,c7),true),2).obs(loc(ref1_book2,c7),false,4).
hpd(test(rob1,loc(rob1,c6),true),5).hpd(test(rob1,loc(ref3_book2,c6),true),6).hpd(test(rob1,loc(ref3_book2,c8),true),0).obs(loc(ref3_book2,c6),false,7).
obs(loc(rob1,c7),true,3).
obs(loc(ref3_book2,c8),false,1).
hpd(test(rob1,loc(ref1_book2,c7),true),3).hpd(test(rob1,loc(rob1,c7),true),2).obs(loc(ref1_book2,c7),false,4).
hpd(test(rob1,loc(ref3_book2,c8),true),0).obs(loc(rob1,c7),true,3).
obs(loc(ref3_book2,c8),false,1).
hpd(test(rob1,loc(ref3_book2,c8),true),0).obs(loc(ref3_book2,c8),false,1).
