...
class DomainInfo():
	...
	def __init__(self,complexity_level):
		...
		if complexity_level == 1:
			...
			self.In_handBook3_index = 6
			self.In_handBook1_Ref1_index = 7
			self.In_handBook1_Ref2_index = 8
			self.In_handBook1_Ref3_index = 9
			self.In_handBook2_Ref1_index = 10
			self.In_handBook2_Ref2_index = 11
			self.In_handBook2_Ref3_index = 12
			self.In_handBook3_Ref1_index = 13
			self.In_handBook3_Ref2_index = 14
			self.In_handBook3_Ref3_index = 15
	...
	def refinedAnswerToRefinedState(self,answer):
		...
		for holds in answer_split:
			if not (holds[0] == '-'):
				...
				if(fluent[0:4] == 'loc('):
					...
					if(split_fluent[0] == 'ref1_book1'): new_refined_state[self.LocationBook1_index] = split_fluent[1]
					if self.complexity_level > 1:
						if(split_fluent[0] == 'ref2_book1'):
							new_refined_state[self.LocationBook1_index] = split_fluent[1]
						if(split_fluent[0] == 'ref1_book2'):
							new_refined_state[self.LocationBook2_index] = split_fluent[1]
						if(split_fluent[0] == 'ref2_book2'):
							new_refined_state[self.LocationBook2_index] = split_fluent[1]
					if self.complexity_level > 2:
						if(split_fluent[0] == 'ref3_book1'):
							new_refined_state[self.LocationBook1_index] = split_fluent[1]
						if(split_fluent[0] == 'ref3_book2'):
							new_refined_state[self.LocationBook2_index] = split_fluent[1]
						if(split_fluent[0] == 'ref1_book3'):
							new_refined_state[self.LocationBook3_index] = split_fluent[1]
						if(split_fluent[0] == 'ref2_book3'):
							new_refined_state[self.LocationBook3_index] = split_fluent[1]
						if(split_fluent[0] == 'ref3_book3'):
							new_refined_state[self.LocationBook3_index] = split_fluent[1]
					if self.complexity_level > 3:
						if(split_fluent[0] == 'ref4_book1'):
							new_refined_state[self.LocationBook1_index] = split_fluent[1]
						...
						if(split_fluent[0] == 'ref2_book4'):
							new_refined_state[self.LocationBook4_index] = split_fluent[1]
						if(split_fluent[0] == 'ref3_book4'):
							new_refined_state[self.LocationBook4_index] = split_fluent[1]
						if(split_fluent[0] == 'ref4_book4'):
							new_refined_state[self.LocationBook4_index] = split_fluent[1]
				elif(fluent[0:8] == 'in_hand('):
					fluent = fluent[8:-1]
					split_fluent = fluent.split(',')
		...
		new_refined_state[self.In_handBook1_index] = 'false'
		if (new_refined_state[self.In_handBook1_Ref1_index] == 'true'): new_refined_state[self.In_handBook1_index] = 'true'
		if self.complexity_level > 1:
			new_refined_state[self.In_handBook2_index] = 'false'
			if (new_refined_state[self.In_handBook1_Ref2_index] == 'true'): new_refined_state[self.In_handBook1_index] = 'true'
			if (new_refined_state[self.In_handBook2_Ref1_index] == 'true') or (new_refined_state[self.In_handBook2_Ref2_index] == 'true'): new_refined_state[self.In_handBook2_index] = 'true'
		if self.complexity_level > 2:
			new_refined_state[self.In_handBook3_index] = 'false'
			if (new_refined_state[self.In_handBook1_Ref3_index] == 'true'): new_refined_state[self.In_handBook1_index] = 'true'
			if (new_refined_state[self.In_handBook2_Ref3_index] == 'true'): new_refined_state[self.In_handBook2_index] = 'true'
			if (new_refined_state[self.In_handBook3_Ref1_index] == 'true') or (new_refined_state[self.In_handBook3_Ref2_index] == 'true') or (new_refined_state[self.In_handBook3_Ref3_index] == 'true'): new_refined_state[self.In_handBook3_index] = 'true'
		if self.complexity_level > 3:
			new_refined_state[self.In_handBook4_index] = 'false'
			if (new_refined_state[self.In_handBook1_Ref4_index] == 'true'): new_refined_state[self.In_handBook1_index] = 'true'
	...
	def getIndexesRelevantToGoal(self,goal):
		...
		for condition in conditions:
			...
			if 'in_hand' in fluent:
				...
				if self.complexity_level > 1:
					if 'book2' in fluent: indexes.add(self.In_handBook2_index)
				if self.complexity_level > 2:
					if 'book3' in fluent: indexes.add(self.In_handBook3_index)
				if self.complexity_level > 3:
					if 'book4' in fluent: indexes.add(self.In_handBook4_index)
			elif 'loc' in fluent:
				if 'rob1' in fluent: indexes.add(self.LocationRobot_index)
				elif 'book1' in fluent: indexes.add(self.LocationBook1_index)
				if self.complexity_level > 1:
					if 'book2' in fluent: indexes.add(self.LocationBook2_index)
				if self.complexity_level > 2:
					if 'book3' in fluent: indexes.add(self.LocationBook3_index)
				if self.complexity_level > 3:
					if 'book4' in fluent: indexes.add(self.LocationBook4_index)
		return indexes
