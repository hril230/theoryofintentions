...
asp_planning_file = 'ASP_files/ASP_Traditional.sp'
preASP_planning_file = 'pre_ASP_files/preASP_Traditional.txt'
preASP_planning_split = None
history_index_planning_asp = None


belief_history_marker = '%% *_*_*'
asp_belief_file = 'ASP_files/ASP_Believe.sp'
asp_diagnosing_file = 'ASP_files/ASP_Diagnosis.sp'
