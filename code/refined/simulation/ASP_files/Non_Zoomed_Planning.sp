...
%% Goal:
%%%%%%%%%
goal(I) :- -holds(coarse_in_hand(rob1,book1),I),-holds(coarse_in_hand(rob1,book3),I),holds(coarse_loc(rob1,kitchen),I),-holds(coarse_in_hand(rob1,book2),I),holds(coarse_loc(book3,office1),I),holds(coarse_loc(book1,office2),I),holds(coarse_loc(book2,office1),I).
