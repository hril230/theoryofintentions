...
observed(#robot,#fluent,#boolean,#step).
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 rules
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Causal Laws %%
...
observed(R,loc(R,L2),true,I) :- try_observing(R,loc(R,L),I), holds(loc(R,L2),I).

observed(R,loc(O,L2),false,I) :- try_observing(R,loc(O,L),I), holds(loc(R,L2),I), -holds(loc(O,L2),I).
observed(R,loc(O,L2),true,I) :- try_observing(R,loc(O,L),I), holds(loc(R,L2),I), holds(loc(O,L2),I).

observed(R,in_hand(R,O2),true,I) :- try_observing(R,in_hand(R,O1),I), holds(in_hand(R,O2),I).
observed(R,in_hand(R,O),false,I) :- try_observing(R,in_hand(R,O),I), -holds(in_hand(R,O),I).

observed(R,locked(L),true,I) :- try_observing(R,locked(L),I), holds(loc(R,K),I), next_to(K,L), holds(locked(L),I).
observed(R,locked(L),true,I) :- try_observing(R,locked(L),I), holds(loc(R,L),I), holds(locked(L),I).
observed(R,locked(L),false,I) :- try_observing(R,locked(L),I), holds(loc(R,K),I), next_to(K,L), -holds(locked(L),I).
observed(R,locked(L),false,I) :- try_observing(R,locked(L),I), holds(loc(R,L),I), -holds(locked(L),I).
